    ...
    <div className="min-h-screen bg-rise-mist font-sans text-rise-deep">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16">
        ...
        <div className="border-b border-rise-ocean pb-4">
          <h1 className="text-4xl font-bold text-rise-deep tracking-tight">Mechanisms</h1>
        </div>
        ...
        <section className="bg-rise-frost rounded-xl shadow-md border border-rise-ocean overflow-hidden p-8">
          <h2 className="text-2xl font-bold text-rise-deep mb-4">{researchMechanisms[0].title}</h2>
          <p className="text-rise-deep leading-relaxed text-lg text-justify mb-8">
            {researchMechanisms[0].content}
          </p>
          <div className="w-full bg-rise-deep/5 rounded-lg overflow-hidden flex items-center justify-center">
        ...
        <section className="bg-rise-frost rounded-xl shadow-md border border-rise-ocean overflow-hidden p-8">
          <div className="flex flex-col md:flex-row gap-8 items-center">
            <div className="md:w-1/2">
              <h2 className="text-2xl font-bold text-rise-deep mb-4">{researchMechanisms[1].title}</h2>
