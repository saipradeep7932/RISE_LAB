...
const Footer = () => {
  return (
    <footer className="bg-[#07374A] text-white pt-16 pb-8 border-t border-gray-800 font-sans">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-24 mb-12">
          ...
          <div>
            ...
            <ul className="grid grid-cols-2 gap-x-8 gap-y-3 text-sm">
              ...
              <li><Link to="/projects-funded" className="hover:text-[#FF6600] transition-colors">Projects Funding</Link></li>
